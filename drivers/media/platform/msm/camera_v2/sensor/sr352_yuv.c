...
#include "sr352.h"
#if defined (CONFIG_MACH_MILLETWIFIUS_OPEN) || defined (CONFIG_MACH_MILLETLTE_VZW) || defined (CONFIG_MACH_MILLETLTE_ATT) || defined (CONFIG_MACH_DEGASLTE_SPR) || defined (CONFIG_MACH_MILLETLTE_TMO) || defined (CONFIG_MACH_MILLETLTE_CAN)
...
void sr352_check_hw_revision()
{
    CDBG(" Hardware revision = %d\n",system_rev);
            ...
            if(system_rev >= 7)
                settings_type = 1;
#elif defined (CONFIG_SEC_MATISSE_PROJECT) || defined (CONFIG_MACH_MILLETLTE_ATT) || defined(CONFIG_SEC_DEGAS_PROJECT) || defined (CONFIG_MACH_MILLETLTE_TMO) || defined (CONFIG_MACH_MILLETLTE_CAN)
                settings_type = 1;
#endif
}
